...
public class GameWin extends BaseScreen implements ButtonActions<GameEndBtn>{
    private HashMap<GameEndBtn, Button> buttons;

    public GameWin(MainFrame mainFrame) {
        super(mainFrame);
        initialize();
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawImage(ImageResource.WIN_BACKGROUND.getImage(), 0, 0, getWidth(), getHeight(), null);
    }
}