...
public class MainMenu extends BaseScreen implements ButtonActions<MainButton> {
    ...
    public void createButton() {
        ...
        buttons.get(MainButton.SOUND).setIcon(new ImageIcon(ImageResource.SOUND.getScaledImage(85, 85)));
        buttons.put(MainButton.SOUND_OFF, new Button());
        buttons.get(MainButton.SOUND_OFF).setVisible(false);
        buttons.get(MainButton.SOUND_OFF).setIcon(new ImageIcon(ImageResource.SOUND_OFF.getScaledImage(85, 85)));
    }
